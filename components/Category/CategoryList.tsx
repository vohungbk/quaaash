...
export const CategoryList: FC<CategoryListProps> = ({
  ...
  return (
    <section className={clsx('px-[135px] pt-[76px]', className)}>
      <div className="flex justify-between items-center flex-wrap mb-[80px]">
        <div className="flex items-center justify-between gap-2 md:gap-[78px] mb-5 lg:mb-0">
          <h2 className="font-[Inter] font-semibold text-[62px] leading-[38px]">
            {title}
          </h2>
